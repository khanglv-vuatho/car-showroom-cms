...
const Header = () => {
  return (
    <header className='flex h-16 w-full shrink-0 items-center justify-between gap-2 px-4 py-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12'>
